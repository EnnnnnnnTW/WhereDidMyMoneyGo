const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LoginView-C1A0rkpr.js","assets/LoginView-C1fic990.css","assets/AddRecordView-WOaJ63dT.js","assets/PageHeader-BXQp6e0v.js","assets/PageHeader-C9N52_v9.css","assets/RecordForm-Cyw4CpRd.js","assets/RecordForm-iza_1PRV.css","assets/AddRecordView-tn0RQdqM.css","assets/RecordsView-B42w6E4H.js","assets/RecordsView-D3wg-9ds.css","assets/MeView-A7Y2N3qt.js","assets/MeView-B-1NMiq7.css","assets/GroupView-BNAvon4F.js","assets/GroupView-xwnM8zhq.css"])))=>i.map(i=>d[i]);
...
`)};function _i(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(Vo.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function Zh(a){let f="";return Rt(a,function(p,m){f+=m,f+=":",f+=p,f+=`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ut="WebChannelConnection";class pC extends fC{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,n,r,s,i){const o=su();return new Promise((c,l)=>{const u=new i_;u.setWithCredentials(!0),u.listenOnce(o_.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case ta.NO_ERROR:const d=u.getResponseJson();X(ut,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(d)),c(d);break;case ta.TIMEOUT:X(ut,`RPC '${e}' ${o} timed out`),l(new z(O.DEADLINE_EXCEEDED,"Request time out"));break;case ta.HTTP_ERROR:const g=u.getStatus();if(X(ut,`RPC '${e}' ${o} failed with status:`,g,"response text:",u.getResponseText()),g>0){let _=u.getResponseJson();Array.isArray(_)&&(_=_[0]);const S=_==null?void 0:_.error;if(S&&S.status&&S.message){const N=function(j){const U=j.toLowerCase().replace(/_/g,"-");return Object.values(O).indexOf(U)>=0?U:O.UNKNOWN}(S.status);l(new z(N,S.message))}else l(new z(O.UNKNOWN,"Server responded with status "+u.getStatus()))}else l(new z(O.UNAVAILABLE,"Connection failed."));break;default:oe(9055,{l_:e,streamId:o,h_:u.getLastErrorCode(),P_:u.getLastError()})}}finally{X(ut,`RPC '${e}' ${o} completed.`)}});const h=JSON.stringify(s);X(ut,`RPC '${e}' ${o} sending request:`,s),u.send(n,"POST",h,r,15)})}T_(e,n,r){const s=su(),i=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=l_(),c=c_(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(l.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(l.useFetchStreams=!0),this.jo(l.initMessageHeaders,n,r),l.encodeInitMessageHeaders=!0;const h=i.join("");X(ut,`Creating RPC '${e}' stream ${s}: ${h}`,l);const d=o.createWebChannel(h,l);this.I_(d);let g=!1,_=!1;const S=new dC({Yo:V=>{_?X(ut,`Not sending because RPC '${e}' stream ${s} is closed:`,V):(g||(X(ut,`Opening RPC '${e}' stream ${s} transport.`),d.open(),g=!0),X(ut,`RPC '${e}' stream ${s} sending:`,V),d.send(V))},Zo:()=>d.close()}),N=(V,j,U)=>{V.listen(j,H=>{try{U(H)}catch(G){setTimeout(()=>{throw G},0)}})};return N(d,Ci.EventType.OPEN,()=>{_||(X(ut,`RPC '${e}' stream ${s} transport opened.`),S.o_())}),N(d,Ci.EventType.CLOSE,()=>{_||(_=!0,X(ut,`RPC '${e}' stream ${s} transport closed`),S.a_(),this.E_(d))}),N(d,Ci.EventType.ERROR,V=>{_||(_=!0,js(ut,`RPC '${e}' stream ${s} transport errored. Name:`,V.name,"Message:",V.message),S.a_(new z(O.UNAVAILABLE,"The operation could not be completed")))}),N(d,Ci.EventType.MESSAGE,V=>{var j;if(!_){const U=V.data[0];we(!!U,16349);const H=U,G=(H==null?void 0:H.error)||((j=H[0])==null?void 0:j.error);if(G){X(ut,`RPC '${e}' stream ${s} received error:`,G);const ae=G.status;let ce=function(y){const b=He[y];if(b!==void 0)return G_(b)}(ae),R=G.message;ce===void 0&&(ce=O.INTERNAL,R="Unknown error status: "+ae+" with message "+G.message),_=!0,S.a_(new z(ce,R)),d.close()}else X(ut,`RPC '${e}' stream ${s} received:`,U),S.u_(U)}}),N(c,a_.STAT_EVENT,V=>{V.stat===Wl.PROXY?X(ut,`RPC '${e}' stream ${s} detected buffering proxy`):V.stat===Wl.NOPROXY&&X(ut,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{S.__()},0),S}terminate(){this.c_.forEach(e=>e.close()),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter(n=>n===e)}}function _l(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
